...
document.write('<script src="http://mozilla.github.io/pdf.js/build/pdf.js"></script>');
document.write('<script src="https://rawcdn.githack.com/rstefan/pdfviewer/959aa0cd1e552ca694ebd53a93d6103e5fec4410/pdfviewer.js"></script>');
document.write('<link rel="stylesheet" type="text/css" href="https://rawcdn.githack.com/rstefan/pdfviewer/959aa0cd1e552ca694ebd53a93d6103e5fec4410/pdfviewer.css">');
document.write('<style>.mdui-appbar .mdui-toolbar{height:56px;font-size:1pc}.mdui-toolbar>*{padding:0 6px;margin:0 2px}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>.mdui-typo-headline{padding:20px 0 0 0}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{max-width:980px}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}.mdui-toolbar>.mdui-typo-headline,.mdui-toolbar>a:last-child,.mdui-toolbar>i:first-child{display:block}}</style>');
...
function nav(path) {
    ...
    var html = "";
    var cur = window.current_drive_order || 0;
    html += `<a href="/${cur}:/" class="mdui-typo-headline folder"><img src="https://doctorplus.club/wp-content/uploads/2020/04/logo-messenger.png" height="30px" title="${document.siteName}"></a>`;
    ...
    var search_bar = `<div class="mdui-toolbar-spacer"></div>
		...
		if(dark){
		search_bar += `<input class="mdui-textfield-input mdui-text-color-white-text" type="text" name="q" placeholder="Search in current drive" value="${search_text}"/>`;
		}else{
		search_bar += `<input class="mdui-textfield-input" type="text" name="q" placeholder="Search in current drive" value="${search_text}"/>`;
		}
        search_bar += `		            
            </form>
	...
	var search_current = `<div class="mdui-toolbar-spacer"></div>
		<div id="search_bar" class="mdui-textfield mdui-textfield-expandable mdui-float-right ${model.is_search_page ? 'mdui-textfield-expanded' : ''}">
            <button class="mdui-textfield-icon mdui-btn mdui-btn-icon" onclick="if($('#search_bar').hasClass('mdui-textfield-expanded') && $('#search_bar_form>input').val()) $('#search_bar_form').submit();">
                <i class="mdui-icon material-icons">search</i>
            </button>
		...
		if(dark){
		search_current += `<input class="mdui-textfield-input mdui-text-color-white-text" id="myInput" onkeyup="myFunction()" type="text" placeholder="Tìm kiếm trong thư mục"></input>`;
		}else{
		search_current += `<input class="mdui-textfield-input" id="myInput" onkeyup="myFunction()" type="text" placeholder="Tìm kiếm trong thư mục"></input>`;
		}
        search_current += `
            </div>
            <button class="mdui-textfield-close mdui-btn mdui-btn-icon"><i class="mdui-icon material-icons">close</i></button>
...
<div class="mdui-container-fluid">
	<br>
<div class="pdf-container" data-href="${url}"></div>
